...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Batman" , IsActive = true },
              new(){ PersonId  = 2, Name = "Spider-man" , IsActive = false },
              new(){ PersonId  = 3, Name = "Lucifer" , IsActive = true },
              new(){ PersonId  = 4, Name = "Rise" , IsActive = false },
              new(){ PersonId  = 5, Name = "Skywalker" , IsActive = true },
              new(){ PersonId  = 6, Name = "Megadeth" , IsActive = true },
              new(){ PersonId  = 7, Name = "Gençay" , IsActive = false },
              new(){ PersonId  = 8, Name = "Hoca" , IsActive = true },
              new(){ PersonId  = 9, Name = "Adamın" , IsActive = false },
              new(){ PersonId  = 10, Name = "Dibidir" , IsActive = false },
        });
    }
}
