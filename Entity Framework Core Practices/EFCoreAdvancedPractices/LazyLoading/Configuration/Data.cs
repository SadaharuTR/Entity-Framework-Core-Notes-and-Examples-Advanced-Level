...
public class EmployeeData : IEntityTypeConfiguration<Employee>
{
    public void Configure(EntityTypeBuilder<Employee> builder)
    {
        ...
        {
                new(){ Id = 1, RegionId = 1, Name = "Dave", Surname = "Mustaine", Salary = 1500},
                new(){ Id = 2, RegionId = 2, Name = "David", Surname = "Ellefson", Salary = 1500},
                new(){ Id = 3, RegionId = 1, Name = "Joe", Surname = "Satriani", Salary = 1500},
                new(){ Id = 4, RegionId = 2, Name = "Ronnie", Surname = "James Dio", Salary = 1500},
        });
    }
}
