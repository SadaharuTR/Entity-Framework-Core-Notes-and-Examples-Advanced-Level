...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Teresa" },
              new(){ PersonId  = 2, Name = "Michael" },
              new(){ PersonId  = 3, Name = "Şükriye" },
              new(){ PersonId  = 4, Name = "Süleyman" },
              new(){ PersonId  = 5, Name = "Fatmanur" },
              new(){ PersonId  = 6, Name = "Faruk" },
              new(){ PersonId  = 7, Name = "Nalan" },
              new(){ PersonId  = 8, Name = "Gül" },
              new(){ PersonId  = 9, Name = "Bertunçcan" },
              new(){ PersonId  = 10, Name = "Ayşenaz" },
        });
    }
}
