...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Robocop" },
              new(){ PersonId  = 2, Name = "Önder" },
              new(){ PersonId  = 3, Name = "Metin" },
              new(){ PersonId  = 4, Name = "Tekin" },
              new(){ PersonId  = 5, Name = "Serdar" },
              new(){ PersonId  = 6, Name = "Ali" },
              new(){ PersonId  = 7, Name = "Onur" },
              new(){ PersonId  = 8, Name = "Jale" },
              new(){ PersonId  = 9, Name = "Ayşenur" },
              new(){ PersonId  = 10, Name = "Fatma" },
        });
    }
}
