...
public class EmployeeData : IEntityTypeConfiguration<Employee>
{
    public void Configure(EntityTypeBuilder<Employee> builder)
    {
        ...
        {
                new(){ Id = 1, RegionId = 1, Name = "Sertaç", Surname = "Tantan", Salary = 1500},
                new(){ Id = 2, RegionId = 2, Name = "Mahmut", Surname = "Tantan", Salary = 1500},
                new(){ Id = 3, RegionId = 1, Name = "Rıfkı", Surname = "Papaz", Salary = 1500},
                new(){ Id = 4, RegionId = 2, Name = "Cüneyt", Surname = "Çakır", Salary = 1500},
        });
    }
}
