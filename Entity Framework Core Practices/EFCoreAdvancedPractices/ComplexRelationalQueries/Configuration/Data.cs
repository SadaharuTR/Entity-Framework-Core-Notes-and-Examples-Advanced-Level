...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Esdeath", Gender = Gender.Woman },
              new(){ PersonId  = 2, Name = "Kurosaki", Gender = Gender.Man},
              new(){ PersonId  = 3, Name = "Matsumoto", Gender = Gender.Woman },
              new(){ PersonId  = 4, Name = "Kanuni", Gender = Gender.Man },
              new(){ PersonId  = 5, Name = "Sultan", Gender = Gender.Woman },
              new(){ PersonId  = 6, Name = "Süleyman", Gender = Gender.Man },
              new(){ PersonId  = 7, Name = "Güllü", Gender = Gender.Woman },
              new(){ PersonId  = 8, Name = "Polat", Gender = Gender.Woman },
              new(){ PersonId  = 9, Name = "Memati", Gender = Gender.Man },
              new(){ PersonId  = 10, Name = "Abdulhey", Gender = Gender.Woman },
        });
    }
}
