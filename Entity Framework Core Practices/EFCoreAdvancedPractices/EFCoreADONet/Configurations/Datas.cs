...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Mainur" },
              new(){ PersonId  = 2, Name = "Sertaç" },
              new(){ PersonId  = 3, Name = "Demon Lord" },
              new(){ PersonId  = 4, Name = "Hakan" },
              new(){ PersonId  = 5, Name = "Numenor" },
              new(){ PersonId  = 6, Name = "Krillin" },
              new(){ PersonId  = 7, Name = "Lale" },
              new(){ PersonId  = 8, Name = "Güllü" },
              new(){ PersonId  = 9, Name = "Polat" },
              new(){ PersonId  = 10, Name = "Ramiz" },
        });
    }
}
