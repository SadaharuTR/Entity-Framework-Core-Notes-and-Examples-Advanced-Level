...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Sinan" },
              new(){ PersonId  = 2, Name = "Engin" },
              new(){ PersonId  = 3, Name = "Ahmet" },
              new(){ PersonId  = 4, Name = "Çakar" },
              new(){ PersonId  = 5, Name = "Abdulkerim" },
              new(){ PersonId  = 6, Name = "Yılmaz" },
              new(){ PersonId  = 7, Name = "Cristiano" },
              new(){ PersonId  = 8, Name = "Ronaldo" },
              new(){ PersonId  = 9, Name = "Lionel" },
              new(){ PersonId  = 10, Name = "Messi" },
        });
    }
}
