...
public class PersonData : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        {
              new(){ PersonId  = 1, Name = "Optimus" },
              new(){ PersonId  = 2, Name = "Bumblebee" },
              new(){ PersonId  = 3, Name = "Ironhide" },
              new(){ PersonId  = 4, Name = "Kup" },
              new(){ PersonId  = 5, Name = "Springer" },
              new(){ PersonId  = 6, Name = "Racthet" },
              new(){ PersonId  = 7, Name = "Jazz" },
              new(){ PersonId  = 8, Name = "Prowl" },
              new(){ PersonId  = 9, Name = "Megatron" },
              new(){ PersonId  = 10, Name = "Starscream" },
        });
    }
}
